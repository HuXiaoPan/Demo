...
shape_polygon::shape_polygon(float *data, int size, unsigned int *elem_data, int elem_size) : shape_base(0)
{
    this->size = size/28;
    size_ebo = elem_size/4;
    ...
    glBufferData(GL_ELEMENT_ARRAY_BUFFER, elem_size, elem_data, GL_STATIC_DRAW);
