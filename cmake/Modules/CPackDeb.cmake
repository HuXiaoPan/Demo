...
Depends: 
# Provides:
Source: https://review.easydrivetech.com/
#Essential: no
")
  ...
  if(${_result})
    ...
    list(GET CPACK_INSTALL_CMAKE_PROJECTS 0 _installdir)
    file(RENAME ${CPACK_TOPLEVEL_DIRECTORY}/${OPKG_FILE_NAME}.ipk ${_installdir}/${OPKG_FILE_NAME}.ipk)
  endif(${_result})
