...
message(STATUS "!!! IOS.cmake !!!")

SET(APPLE 1)
SET(IOS 1)

# by default we don't want shared libs on iOS
...
SET(CMAKE_CXX_LINK_FLAGS "-Wl,-headerpad_max_install_names -stdlib=libc++")
...
set(CMAKE_EXE_LINKER_FLAGS "-stdlib=libc++ -lz -lm -framework MobileCoreServices -framework UIKit -framework OpenGLES -framework Foundation -framework QuartzCore -framework CoreFoundation -framework CoreText -framework CoreGraphics -framework Security -framework SystemConfiguration")
