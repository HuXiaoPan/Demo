...
# cmake .. -DCMAKE_TOOLCHAIN_FILE=../cmake/OS/naip/naip-10.0.0-cortexa9hf-vfp-neon.cmake -DSYSTEM_CURL=ON -DCMAKE_BUILD_TYPE=Release -DUSE_QT=OFF -DNABASE_EGL_BACKEND=Wayland -DUSE_GLESV2_DEFAULT=ON -DCMAKE_INSTALL_PREFIX=/opt/easydrive -DWITH_PLUGINS=off -DWITH_DOCS=off
...
set( CMAKE_SYSROOT /opt/naip/${NAIP_VERSION}/nitrogen6x/sysroots/cortexa9hf-vfp-neon-naip-linux-gnueabi)
...
set( CMAKE_C_COMPILER /opt/naip/${NAIP_VERSION}/nitrogen6x/sysroots/${HOST_ARCH}-naipsdk-linux/usr/bin/${TARGET_ARCH}-naip-linux-gnueabi/${TARGET_ARCH}-naip-linux-gnueabi-gcc )
set( CMAKE_CXX_COMPILER /opt/naip/${NAIP_VERSION}/nitrogen6x/sysroots/${HOST_ARCH}-naipsdk-linux/usr/bin/${TARGET_ARCH}-naip-linux-gnueabi/${TARGET_ARCH}-naip-linux-gnueabi-g++ )
...
#add_definitions( -DLINUX -DEGL_API_FB -DEGL_API_WL )
add_definitions( -DLINUX -DEGL_API_FB )

# Set qt host binary location
set( OE_QMAKE_PATH_EXTERNAL_HOST_BINS /opt/naip/${NAIP_VERSION}/nitrogen6x/sysroots/${HOST_ARCH}-naipsdk-linux/usr/bin/qt5 )
...
set( CMAKE_FIND_ROOT_PATH ${CMAKE_SYSROOT} /opt/naip/${NAIP_VERSION}/nitrogen6x/sysroots/${HOST_ARCH}-naipsdk-linux )
