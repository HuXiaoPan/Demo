...
if(QNX_USE_LIBCPP)
   ...
   ########################################################
   # Dinkumware lib in QNX 6.6.0 is compiled in C++11 mode,
   ...
   if(CMAKE_SYSTEM_PROCESSOR STREQUAL "armv7")
      set( QNX_CXX_FLAGS "${QNX_CXX_FLAGS} -isystem ${QNX_HOST}/usr/lib/gcc/arm-unknown-nto-qnx6.6.0eabi/4.7.3/include")
      set( QNX_CPP_STDLIB "${QNX_CPP_STDLIB} -Wl,-L${QNX_HOST}/usr/lib/gcc/arm-unknown-nto-qnx6.6.0eabi/4.7.3")
   elseif(CMAKE_SYSTEM_PROCESSOR STREQUAL "x86")
      set( QNX_CXX_FLAGS "${QNX_CXX_FLAGS} -fno-stack-protector")
      set( QNX_C_FLAGS "${QNX_C_FLAGS} -fno-stack-protector")
      set( QNX_CXX_FLAGS "${QNX_CXX_FLAGS} -isystem ${QNX_HOST}/usr/lib/gcc/i486-pc-nto-qnx6.6.0/4.7.3/include")
      set( QNX_CPP_STDLIB "${QNX_CPP_STDLIB} -Wl,-L${QNX_HOST}/usr/lib/gcc/i486-pc-nto-qnx6.6.0/4.7.3")
   endif()

   set( QNX_CPP_STDLIB "${QNX_CPP_STDLIB} -Wl,-L${QNX_TARGET}/${CMAKE_CXX_LIBRARY_ARCHITECTURE}/lib/gcc/4.7.3")
