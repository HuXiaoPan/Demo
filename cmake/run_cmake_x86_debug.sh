...
if [ ! -d "/edna_build_x86_debug/" ];then
  mkdir -m 777 edna_build_x86_debug
else
  echo "The folder edna_build_x86_debug already exists"
fi

if [ ! -d "/edna_install_x86_debug/" ];then
  mkdir -m 777 edna_install_x86_debug
else
  echo "The folder edna_install_x86_debug already exists"
fi
